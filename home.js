...
function canWeDeliver (zipCode){
    ...
    return "Your zipcode is elegible for delivery"
} else {
    return "Your zipcode is not elegible for delivery"
}
}
console.log(canWeDeliver(85205));
console.log(canWeDeliver(85255));
...
console.log(canWeDeliverTwo(85255));
